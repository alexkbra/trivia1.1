package co.com.elpoli;

import co.com.elpoli.config.ApplicationProperties;
import co.com.elpoli.config.DefaultProfileUtil;
...
public class TriviaApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TriviaApp.class);

    private final Environment env;

    public TriviaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TriviaApp.class);
