...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/participar'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Participar) {
        return item.id;
    }
    registerChangeInParticipars() {
        this.eventSubscriber = this.eventManager.subscribe('participarListModification', (response) => this.loadAll());
    }
