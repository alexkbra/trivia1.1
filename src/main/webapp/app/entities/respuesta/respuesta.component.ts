...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/respuesta'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInRespuestas() {
        this.eventSubscriber = this.eventManager.subscribe('respuestaListModification', (response) => this.loadAll());
    }
